package com.app.ats.com.logintest.openfire;
...
public class MyXMPP {
     ...
     * @return 1, Successfully registered 0, server did not return results in 2, the 3, failed to register account already exists
     */
